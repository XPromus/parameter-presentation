...
<div class="flex flex-col items-center h-full max-h-full rounded-md">
    <div class="flex justify-center w-full min-h-0 rounded-md max-h-1/2 basis-1/2 bg-gray-500/50"> 
    ...
    <div class="flex flex-col space-y-2">
        <div class="flex flex-row w-full space-x-2"> 
            ...
            <Input bind:value={media.name} onChange={onChange} type="text" placeholder="Name of image" />
        </div>
        <div class="flex flex-row w-full space-x-2"> 
